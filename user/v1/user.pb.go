...
import (
	v1 "github.com/thietkewebgiare/proto/common/v1"
...
type LoginResponse struct {
	...
	Code    v1.Code          `protobuf:"varint,1,opt,name=code,proto3,enum=api.common.v1.Code" json:"code,omitempty"`
	Message string           `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	Data    *AccessTokenData `protobuf:"bytes,3,opt,name=data,proto3" json:"data,omitempty"`
}
...
func (x *LoginResponse) GetCode() v1.Code {
	if x != nil {
		return x.Code
	}
	return v1.Code(0)
...
func (x *LoginResponse) GetData() *AccessTokenData {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_user_v1_user_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x40, 0x0a, 0x0c, 0x4c, 0x6f, 0x67, 0x69, 0x6e,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x12, 0x1a, 0x0a,
	0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x34, 0x0a, 0x0f, 0x41, 0x63, 0x63,
	0x65, 0x73, 0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x44, 0x61, 0x74, 0x61, 0x12, 0x21, 0x0a, 0x0c,
	...
	0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x76, 0x31,
	0x2e, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x44, 0x61, 0x74, 0x61,
	0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0x60, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x51, 0x0a, 0x05, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x12, 0x19,
	...
	0x76, 0x31, 0x2f, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x42, 0x2d, 0x5a, 0x2b, 0x67, 0x69, 0x74, 0x68,
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x74, 0x68, 0x69, 0x65, 0x74, 0x6b, 0x65, 0x77, 0x65,
	0x62, 0x67, 0x69, 0x61, 0x72, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x75, 0x73, 0x65,
...
var file_user_v1_user_proto_goTypes = []interface{}{
	...
	(*AccessTokenData)(nil), // 1: api.user.v1.AccessTokenData
	(*LoginResponse)(nil),   // 2: api.user.v1.LoginResponse
	(v1.Code)(0),            // 3: api.common.v1.Code
}
var file_user_v1_user_proto_depIdxs = []int32{
	3, // 0: api.user.v1.LoginResponse.code:type_name -> api.common.v1.Code
	1, // 1: api.user.v1.LoginResponse.data:type_name -> api.user.v1.AccessTokenData
	0, // 2: api.user.v1.UserService.Login:input_type -> api.user.v1.LoginRequest
	2, // 3: api.user.v1.UserService.Login:output_type -> api.user.v1.LoginResponse
